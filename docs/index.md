...
- **読むだけ**: 公開top・第0〜6章・用語集の`article.page-content`からvisible textを抽出し、空白を除外した文字数を400〜600文字/分で換算します。code textは読む対象に含め、commandは実行しません。現行snapshotは75,239文字・170 code blocksで、126〜189分（約2〜3時間）です。
